...
$sql="SELECT name FROM employee, adminpanel.order WHERE adminpanel.order.user_name=employee.user_name and adminpanel.order.idorder=".$_POST['idorder'];
$result2=mysqli_query($connection,$sql);
$r=mysqli_fetch_assoc($result2);
$pdf->Cell(59, 0, 'Served By:', 0, 0);
$pdf->Cell(59, 0,$r['name'], 0, 1);
